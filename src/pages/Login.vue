...
<script>
	...
	import UcInput from '../components/Input.vue'
...
<style scoped>
  ...
  .content .input{width:5.78rem;height:1.92rem; border:1px solid #e5e7e8; background:#fff; margin:0 auto; margin-top:0.68rem;}
